...
class CreateEvent(Base):
    ...
    _event_category_modal_save_locator = (By.CSS_SELECTOR, 'small.button.update.close-reveal-modal > button')
    ...
    def set_event_venue_map(self):
        ...
        #print self.find_element(*self._event_venue_map_data).text
    ...
    def set_event_category(self):
        ...
        self.selenium.find_element(*self._event_choose_categories_locator)
        self.selenium.find_element(*_event_category_modal_save_locator).click()
